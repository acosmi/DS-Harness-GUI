...
const testIncludes = [
  ...
  'apps/*/tests/**/*.spec.ts',
  'downstream/packages/*/tests/**/*.spec.{ts,tsx}',
  'downstream/apps/*/tests/**/*.spec.{ts,tsx}',
  'downstream/release/tests/**/*.spec.ts',
...
const processBoundTests = [
  'downstream/packages/account-acosmi/tests/sdk-oauth.spec.ts',
