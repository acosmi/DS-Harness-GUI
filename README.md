...
pnpm run desktop:package:mac # 在本机生成 arm64 与 x64 macOS 安装包
pnpm run desktop:package:mac:candidate # 生成已签名/公证的 arm64 与 x64 证据
pnpm run desktop:publish:mac # 将本机 macOS 安装包上传到 GitHub Release
pnpm run desktop:package:windows # 在 Windows 上生成 NSIS 安装包
