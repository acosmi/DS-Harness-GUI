...
export interface Config {
  ...
  pollIntervalMs?: number
  /** Delay before the bash dialect may accept Linux exact stdin-wait evidence. */
...
来源：[`packages/shell/tool-pwsh-persistent/src/index.ts:487`](../packages/shell/tool-pwsh-persistent/src/index.ts)
