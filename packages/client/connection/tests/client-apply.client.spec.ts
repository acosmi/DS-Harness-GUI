...
describe('connection client apply', () => {
  ...
  it('treats an Electron app: renderer as loopback even when the hostname is not 127/8', async () => {
    ;(globalThis as Win).location = { hostname: 'dsh-gui', search: '', protocol: 'app:' }
